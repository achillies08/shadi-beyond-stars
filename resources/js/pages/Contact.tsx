            ...
            <main>
                ...
                <section className="bg-gradient-to-br from-burgundy to-nightshade relative flex min-h-[90vh] items-center pt-24">
                    <div className="mx-auto max-w-[1000px] px-[5%] text-center">
                        <div className="text-shadi-gold mb-6 text-[0.62rem] uppercase tracking-[0.45em] before:mr-2 before:content-['✦']">Get in Touch</div>
                ...
                <section className="bg-nightshade mx-auto max-w-[1200px] px-[5%] py-16 md:py-24">
                    <div className="reveal">
                        ...
                        <div className="bg-shadi-gold/5 mt-8 grid grid-cols-1 gap-[2px] md:grid-cols-2">
                            {[
                                { icon: '💬', title: 'WhatsApp', info: '+91 7065777369', sub: 'Fastest for quick questions and bookings', link: 'https://wa.me/917065777369', linkText: 'Message on WhatsApp' },
                                { icon: '☎', title: 'Phone', info: '+91 7065777369', sub: 'For detailed conversations · 10am–8pm IST', link: 'tel:+917065777369', linkText: 'Call Us' },
                                { icon: '✉', title: 'Email', info: 'astrobeyondstars@gmail.com', sub: 'For formal inquiries and documentation', link: 'mailto:astrobeyondstars@gmail.com', linkText: 'Send Email' },
                                { icon: '📍', title: 'Office', info: 'Delhi, India', sub: 'For in-person consultations', link: '#form', linkText: 'Request Address' }
                            ].map((cc, idx) => (
                                <div key={idx} className="bg-nightshade hover:bg-burgundy/80 p-6 md:p-10 text-center transition-all duration-300">
                                    ...
                                    <a href={cc.link} className="font-goudy text-nightshade hover:from-shadi-gold hover:to-shadi-gold-light inline-block cursor-pointer bg-gradient-to-br from-shadi-gold/80 to-shadi-gold px-6 py-[0.6rem] text-[0.6rem] font-semibold tracking-[0.15em] uppercase transition-all duration-300 hover:-translate-y-0.5">
                                        {cc.linkText}
                                    </a>
                                </div>
                            ))}
                ...
                {/* RESPONSE TIMES */}
                <section className="bg-nightshade/80 px-[5%] py-16 md:py-24 text-center">
                ...
                {/* CONTACT FORM */}
                <section id="form" className="bg-nightshade mx-auto max-w-[1200px] px-[5%] py-16 md:py-24">
                    <div className="reveal">
                        ...
                        <div className="bg-burgundy/80 border-shadi-gold/15 mx-auto my-12 max-w-[600px] border p-6 md:p-12">
                            <form onSubmit={submitForm}>
                                ...
                                <div className="mb-6 flex items-start gap-3">
                                    ...
                                    <label className="text-shadi-cream/55 text-[0.9rem] leading-[1.6]" htmlFor="formPrivacy">I agree to receive updates about Shadi Beyond Stars</label>
                                </div>
                    ...
                    <div className="reveal">
                        ...
                        <div className="mx-auto max-w-[700px]">
                            <details className="border-shadi-gold/10 group mb-8 border-b pb-8" open>
                                <summary className="font-goudy text-shadi-gold hover:text-shadi-gold-light mb-4 flex cursor-pointer items-center justify-between text-[1rem] font-semibold transition-colors duration-300 list-none [&::-webkit-details-marker]:hidden">
                                ...
                                <div className="text-shadi-cream/55 mt-4 text-[0.95rem] leading-[1.8]">
                                    The easiest way is to WhatsApp us with your situation. Or book a free 30-minute consultation call where we can understand your needs and recommend next steps. There's no pressure — this is just a discovery conversation.
                                </div>
                            </details>
                            
                            {[
                                { q: 'Do I need to provide my birth details?', a: 'Yes, for any Kundali analysis. We\'ll need: your date of birth, exact time of birth (as precise as possible), and place of birth. This is how we create your birth chart.' },
                                { q: 'How much does it cost to start?', a: 'A free consultation is available to understand your situation. The first paid service (pre-marriage consultation) is typically ₹5,000–₹8,000. Services range from ₹2,500 for quick consultations to ₹75,000+ for complete wedding ceremonies.' },
                                { q: 'What if my wedding is soon (within 1–2 months)?', a: 'We can work fast. Emergency alignment packages are available. WhatsApp us immediately — we\'ll prioritize your case and create a compressed timeline.' },
                                { q: 'Can services be done remotely?', a: 'Some can (Kundali analysis, consultations, muhurat selection). For rituals, we offer proxy performance, guided remote rituals, or we travel to you. Tell us your situation and we\'ll find a solution.' },
                                { q: 'What if I\'m not sure what I need?', a: 'That\'s why we offer free consultations. Tell us your situation — a potential relationship challenge, concerns about marriage, questions about your charts — and we\'ll recommend what you actually need.' },
                                { q: 'How do I book a consultation?', a: 'WhatsApp us, call, or fill out the contact form above. Mention your preferred date and time, and we\'ll confirm. Most consultations can be scheduled within a week.' },
                                { q: 'What\'s the cancellation policy?', a: 'Consultations can be rescheduled with 48 hours notice. For rituals, cancellation terms depend on timing and pandit commitments. We\'ll clarify this when you book.' },
                                { q: 'Do you offer payment plans?', a: 'Yes, for larger services (full wedding ceremonies, multiple rituals). We can discuss flexible payment options. Ask us directly.' },
                                { q: 'How do I know if your services are real?', a: 'Our community speaks for itself. Read the testimonials from couples we\'ve worked with. You can also ask for references — we\'re happy to share.' }
                            ].map((faq, idx) => (
